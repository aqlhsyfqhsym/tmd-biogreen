...
const SlickFactory: React.FC = () => {
    useEffect(() => {
        ...
        jqueryScript.onload = () => {
            ...
            slickScript.onload = () => {
                // Initialize slick with center mode for factory images
                (window as any).$('.factory-slider').slick({
                    centerMode: true,
                    centerPadding: '60px',
                    slidesToShow: 3,
                    responsive: [
    ...
    const factoryImages = [
        ...
        '/images/slick/factory 1.png', // Repeat to have more slides
        '/images/slick/factory 2.png'
    ];
